...
VLN.products = [
  ...
  { id: 'ridge-overshirt', name: 'Ridge Overshirt', cat: 'shirts', slot: 'mid', shape: 'jacket', price: 44.99, cut: 'roomy', adj: -1,
    colors: ['Charcoal', 'Olive', 'Camel'], images: ['images/products/ridge-overshirt.jpg'], four: ['modernist', 'traditionalist'], out: ['Camel:L'], gone: ['XXL'],
  ...
  { id: 'corbin-pleated-trouser', name: 'Corbin Pleated Trouser', cat: 'trousers', slot: 'trousers', shape: 'trouser', price: 39.99, cut: 'true', adj: 3,
    colors: ['Black', 'Stone', 'Chocolate'], images: ['images/products/corbin-pleated-trouser.jpg'], four: ['quiet', 'traditionalist'], badge: 'Bestseller', out: ['Stone:34'], gone: ['32', '36'],
  ...
  { id: 'alder-heavy-tee', name: 'Alder Heavy Tee', cat: 'shirts', slot: 'tops', shape: 'tee', price: 29.99, cut: 'boxy', adj: 0,
    colors: ['Black', 'Ecru', 'Olive'], images: ['images/products/alder-heavy-tee.jpg'], four: ['weekender', 'modernist'], out: ['Ecru:M'], gone: ['S', 'XL'],
  ...
  { id: 'fallon-knit-polo', name: 'Fallon Knit Polo', cat: 'shirts', slot: 'tops', shape: 'polo', price: 34.99, cut: 'slim', adj: 1,
    colors: ['Black', 'Stone', 'Olive'], images: ['images/products/fallon-knit-polo.jpg'], four: ['quiet'], badge: 'Bestseller', out: ['Olive:M'], gone: ['S', 'XL'],
  ...
  { id: 'meridian-waffle-polo', name: 'Meridian Waffle Polo', cat: 'shirts', slot: 'tops', shape: 'polo', price: 36.99, cut: 'true', adj: 1,
    colors: ['Ecru', 'Navy', 'Chocolate'], images: ['images/products/meridian-waffle-polo.jpg'], four: ['quiet', 'traditionalist'], out: ['Ecru:L'], gone: ['M'],
  ...
  { id: 'sable-camp-shirt', name: 'Sable Linen Camp Shirt', cat: 'shirts', slot: 'tops', shape: 'shirt', price: 39.99, cut: 'roomy', adj: 0,
    colors: ['Sand', 'Ecru', 'Black'], images: ['images/products/sable-camp-shirt.jpg'], four: ['weekender'], badge: 'New', out: ['Sand:S'], gone: ['L'],
  ...
  { id: 'ardent-merino-crew', name: 'Ardent Merino Crew', cat: 'knitwear', slot: 'mid', shape: 'knit', price: 54.99, cut: 'slim', adj: 2,
    colors: ['Charcoal', 'Oat', 'Navy'], images: ['images/products/ardent-merino-crew.jpg'], four: ['quiet'], out: ['Oat:L'], gone: ['M', 'XXL'],
  ...
  { id: 'hollis-cardigan', name: 'Hollis Shawl Cardigan', cat: 'knitwear', slot: 'mid', shape: 'knit', price: 59.99, cut: 'roomy', adj: -2,
    colors: ['Oat', 'Chocolate', 'Charcoal'], images: ['images/products/hollis-cardigan.jpg'], four: ['weekender', 'traditionalist'], badge: 'New', out: ['Chocolate:M'], gone: ['L'],
  ...
  { id: 'weston-cord-trouser', name: 'Weston Cord Trouser', cat: 'trousers', slot: 'trousers', shape: 'trouser', price: 44.99, cut: 'true', adj: 0,
    colors: ['Camel', 'Chocolate', 'Sage'], images: ['images/products/weston-cord-trouser.jpg'], four: ['weekender', 'traditionalist'], out: ['Sage:30', 'Sage:31'], gone: ['33'],
  ...
  { id: 'drift-linen-trouser', name: 'Drift Linen Trouser', cat: 'trousers', slot: 'trousers', shape: 'trouser', price: 36.99, cut: 'roomy', adj: -1,
    colors: ['Ecru', 'Sand', 'Navy'], images: ['images/products/drift-linen-trouser.jpg'], four: ['weekender'], out: ['Navy:32'], gone: ['30', '34'],
  ...
  { id: 'calder-wide-trouser', name: 'Calder Wide Trouser', cat: 'trousers', slot: 'trousers', shape: 'trouser', price: 42.99, cut: 'roomy', adj: 1,
    colors: ['Black', 'Charcoal', 'Stone'], images: ['images/products/calder-wide-trouser.jpg'], four: ['modernist'], out: ['Stone:32'], gone: ['33'],
  ...
  { id: 'harrow-wool-coat', name: 'Harrow Wool Coat', cat: 'outerwear', slot: 'outer', shape: 'coat', price: 129.99, cut: 'true', adj: 2,
    colors: ['Charcoal', 'Camel', 'Navy'], images: ['images/products/harrow-wool-coat.jpg'], four: ['quiet', 'traditionalist'], badge: 'Bestseller', out: ['Camel:M'], gone: ['S', 'XL'],
  ...
  { id: 'york-quilted-jacket', name: 'York Quilted Jacket', cat: 'outerwear', slot: 'outer', shape: 'jacket', price: 89.99, cut: 'true', adj: -1,
    colors: ['Black', 'Navy', 'Olive'], images: ['images/products/york-quilted-jacket.jpg'], four: ['modernist'], out: ['Olive:S', 'Navy:L'], gone: ['M'],
  ...
  { id: 'hale-chore-jacket', name: 'Hale Chore Jacket', cat: 'outerwear', slot: 'outer', shape: 'jacket', price: 74.99, cut: 'roomy', adj: 0,
    colors: ['Charcoal', 'Camel', 'Navy'], images: ['images/products/hale-chore-jacket.jpg'], four: ['weekender'], badge: 'New', out: ['Camel:L'], gone: ['M'],
